% test_gcn_pf.m - Test Python-trained GCN model via gnn2nnv
%
% Demonstrates the Python -> MATLAB import pipeline:
...
modelPath = fullfile(fileparts(mfilename('fullpath')), 'models', 'e2e_gcn.mat');
fprintf('=== Python-trained GCN Test ===\n');
fprintf('Model: %s\n\n', modelPath);
